...
WebUI.setText(findTestObject('Object Repository/Register/input_email_email'), 'tokotester@email.com')

WebUI.setEncryptedText(findTestObject('Object Repository/Register/input_password_password'), '9NLz+4tGZcQ=')

WebUI.setText(findTestObject('Object Repository/Register/input_password_password_1'), 'tokotester123')
